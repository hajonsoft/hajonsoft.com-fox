import { AppBar, Grid, Select, Toolbar, Typography, useMediaQuery } from '@material-ui/core';
            ...
            <Toolbar >
                <Grid container justify="space-between">
                    ...
                    <Grid item>
                        ...
                        {!isMobile && <Grid container justify="center" alignItems="center" spacing={2} >
                            <Grid item>
                            ...
                            <Grid item>
                                <Styled.HeaderButton color="primary" onClick={() => handleBookmarkClick("contact")}>
