            ...
            <Container>
                <Grid container alignItems="stretch">
                    <Grid item sm={12} md={3} lg container >
                        ...
                        <Grid item sm={12} md={12} lg={12}>
                            <Typography variant="caption"><FormattedMessage id="header.telephone" /></Typography>
                        </Grid>
                    </Grid>
                    <Grid item sm={12} md={2} lg container spacing={1} alignContent="flex-start">
                        <Grid item xs={12}>
                    ...
                    <Grid item sm={12} md={2} lg container spacing={1} alignContent="flex-start">
                        ...
                        <Grid item xs={12}>
                            <Link href="https://github.com/hajonsoft/hajonsoft-hawk" target='_blank' variant="caption">
                                <FormattedMessage id="footer.Hawk" />
                            </Link>

                        </Grid>
                        <Grid item xs={12}>
                            <Link href="https://github.com/hajonsoft/hajonsoft-eagle" target='_blank' variant="caption">
                                <FormattedMessage id="footer.Eagle" />
                            </Link>
                        </Grid>
                        <Grid item xs={12}>
                            <Link href="https://github.com/hajonsoft/hajonsoft-tiger" target='_blank' variant="caption">
