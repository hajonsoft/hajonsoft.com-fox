...
const GetStartedMain = ({onStart, onSee}) => {
    const theme = useTheme();
    const aboveSmall = useMediaQuery(theme.breakpoints.up('sm'));
    return (
        <Container>
            <Grid container justify="center" spacing={6}>
                <Grid item container direction="column"  justify="space-around" md={6} sm={12}>
                    <Grid item>
                    ...
                    <Grid item container justify="center" spacing={4}>
                        <Grid item>
                            <Button variant="contained" color="primary" style={{ textTransform: 'none', backgroundColor: 'white', color: 'black', height: '3rem', width: '15rem' }} onClick={onStart}>
                        ...
                        <Grid item>
                            <Button variant="outlined" style={{ textTransform: 'none', color: 'white', border: '1px solid white', height: '3rem', width: '15rem' }} startIcon={<PlayCircleOutlineIcon fontSize="large" />} onClick={onSee}>
