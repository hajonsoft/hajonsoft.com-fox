    ...
    return (
        <Container>
            <Grid container justify="space-between" spacing={2}>
                ...
                <Grid item sm={12} md={3} lg>
                    <PriceCard name="lifetime" price="2800" paymentTerm="per-15-years" subHeader="haj-umrah" inclusions={['15-years-support', 'unlimited-visa-proxy', 'unlimited-support-calls']} background="#E0E4E8" />
                </Grid>
            </Grid>
        </Container>
    )
